		...
		if (input == true) {
			...
			if (isOwnedPP == true && isOwnedBW == true) {
				...
				if (whatPlace == true) {
					...
					case 1:
						playerList[currentPlayer].cash = playerList[currentPlayer].cash
								- AllBoardPlaces.PARK.houseCost;
						AllBoardPlaces.PARK.houseNum = 1;
						break;
					case 2:
						playerList[currentPlayer].cash = playerList[currentPlayer].cash
								- (AllBoardPlaces.PARK.houseCost * 2);
						AllBoardPlaces.PARK.houseNum = 2;
						break;
					case 3:
						playerList[currentPlayer].cash = playerList[currentPlayer].cash
								- (AllBoardPlaces.PARK.houseCost * 3);
						AllBoardPlaces.PARK.houseNum = 3;
						break;
					case 4:
						playerList[currentPlayer].cash = playerList[currentPlayer].cash
								- (AllBoardPlaces.PARK.houseCost * 4);
						AllBoardPlaces.PARK.houseNum = 4;
						break;
					...
					if (whatPlace == false) {
						...
						case 1:
							playerList[currentPlayer].cash = playerList[currentPlayer].cash
									- AllBoardPlaces.BOARDWALK.houseCost;
							AllBoardPlaces.BOARDWALK.houseNum = 1;
							break;
						case 2:
							playerList[currentPlayer].cash = playerList[currentPlayer].cash
									- (AllBoardPlaces.BOARDWALK.houseCost * 2);
							AllBoardPlaces.BOARDWALK.houseNum = 2;
							break;
						case 3:
							playerList[currentPlayer].cash = playerList[currentPlayer].cash
									- (AllBoardPlaces.BOARDWALK.houseCost * 3);
							AllBoardPlaces.BOARDWALK.houseNum = 3;
							break;
						case 4:
							playerList[currentPlayer].cash = playerList[currentPlayer].cash
									- (AllBoardPlaces.BOARDWALK.houseCost * 4);
							AllBoardPlaces.BOARDWALK.houseNum = 4;
							break;
